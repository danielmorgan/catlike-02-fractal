...
public class Fractal : MonoBehaviour {
    ...
    private void InitializeMaterials () {
        ...
        for (int i = 0; i <= maxDepth; i++) {
            ...
            t *= t;
            materials[i, 0] = new Material(this.material);
            materials[i, 0].color = Color.Lerp(Color.white, Color.yellow, (float) t / 2);
            materials[i, 1] = new Material(this.material);
            materials[i, 1].color = Color.Lerp(Color.white, Color.cyan, (float) t / 2);
        }
    }
